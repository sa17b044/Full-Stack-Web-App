<template>
  <div class="container">
    <h3>Server</h3>
    <div v-if="!edit">
      Name<input type="text" v-model="server_name"/> 
      Source IP<input type="text" v-model="src_ip"/> 
      Source Port<input type="text" v-model="src_port"/>
      Destination IP<input type="text" v-model="dst_ip"/>
      Destination Port<input type="text" v-model="dst_port"/>
      Policy<input type="text" v-model="policy"/>
      Log KNXnetIP<input type="checkbox" v-model="logKNXnetip"/>
      Log file<input type="checkbox" v-model="logToFile"/>
