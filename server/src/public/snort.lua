...
{ 
    ...
    policies =
    {
        ...
        inspection = true,
        services = {'SEARCH_REQUEST','DESCRIPTION_REQUEST'},
        app_services = {'A_IndividualAddress_Write','A_IndividualAddress_Read'},
        detection = true,
        ...
        services = {'SEARCH_REQUEST','CONNECT_REQUEST','knx2_service3'},
        app_services = {'A_IndividualAddress_Write','A_IndividualAddress_Read'},
        
        group_address_level = a,
        group_address_file = 'group_address.esf',
